...
def load_faiss_and_search(query, mbti, month, k=2,):
    try:
...
def find_nearby_tourist_spots(restaurants_data, tourist_spots_df, mbti, month, n=1):
    try:
